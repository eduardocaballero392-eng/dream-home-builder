  ...
  head: () => ({
    meta: [
      ...
      { title: "Atelier Vega · Inmobiliaria boutique" },
      {
        name: "description",
        content:
          "Propiedades boutique curadas en las mejores ubicaciones. Compra, venta y asesoría inmobiliaria con criterio estético.",
      },
      { name: "author", content: "Atelier Vega" },
      { property: "og:title", content: "Atelier Vega · Inmobiliaria boutique" },
      {
        property: "og:description",
        content:
          "Viviendas que se viven, no que se miran. Asesoría privada y gestión completa.",
      },
